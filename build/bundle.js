...
app.use('/api', (0, _expressHttpProxy2.default)('http://react-ssr-api.herokuapp.com', {
    proxyReqOptDecorator: function proxyReqOptDecorator(opts) {
        //this param is to help with security errors with googleoauth flow set up in this course
        opts.headers['x-forwarded-host'] = 'localhost:3000';
        return opts;
    }
}));

app.use(_express2.default.static('public')); //tells express it needs to treat public dir
// as static/public dir available to the outside world

app.get('*', function (req, res) {

    var store = (0, _createStore2.default)(req); //passing req to strip cookie from req to help with auth
...
//import Home from '../client/components/Home' - being rendered by Routes component
exports.default = function (req, store, context) {
    ...
    )); //JSX in nodejs server application
...
function loadData(store) {
    return store.dispatch((0, _actions.fetchUsers)()); //returns Promise representing network request
}
...
var App = function App(_ref) {
    var route = _ref.route;
    //any routes matched during the match routes process passed into the app component as a prop called route
            ...
            value: function render() {
                {
                    switch (this.props.auth) {
                        ...
                        //this tag on server
                        //static object adds new property to context object
                        case null:
                            return _react2.default.createElement(
                                'div',
                                null,
